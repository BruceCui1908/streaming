...
static frame::ptr prepend_aac_header(const frame::ptr &fr, const std::string &aac_conf)
{
    if (!fr || aac_conf.empty())
    {
        throw std::runtime_error("Unable to prepend AAC header with empty parameters.");
    }
